...
namespace conquestgeology.src.Blocks.Behaviors
{
    public class ModCorrectedSlabBlockBehavior : BlockBehaviorSlab
    {
        public ModCorrectedSlabBlockBehavior(Block block) : base(block)
        {
        }
